...
function PuzzlesPage({ notify }) {
  ...
  const puzzles = [
    ...
    },
    {
      id: "spelling-bee",
      title: "Spelling Bee",
      description: "Fetch the latest Spelling Bee answers and pangrams from NYT, save them in Convex, and update GamingWize.",
      icon: "B",
    ...
    },
    {
      id: "letter-boxed",
      title: "Letter Boxed",
      description: "Fetch the latest Letter Boxed solution and board letters from NYT, save them in Convex, and update GamingWize.",
      icon: "LB",
    ...
    },
    {
      id: "sudoku",
      title: "Sudoku",
      description: "Fetch the latest Easy, Medium, and Hard Sudoku solutions from NYT, save them in Convex, and update GamingWize.",
      icon: "9",
    ...
    },
    {
      id: "pips",
      title: "Pips",
      description: "Fetch the latest Easy, Medium, and Hard Pips solutions from NYT, save them in Convex, and update GamingWize.",
      icon: "P",
