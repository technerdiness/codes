...
function getLetrosoArticleUrl(): string {
  return Deno.env.get("WORDPRESS_LETROSO_ARTICLE_URL")?.trim() || DEFAULT_LETROSO_ARTICLE_URL;
}

function getLetrosoMarkerStart(): string {
  return Deno.env.get("WORDPRESS_LETROSO_MARKER_START")?.trim() || DEFAULT_LETROSO_MARKER_START;
}

function getLetrosoMarkerEnd(): string {
  return Deno.env.get("WORDPRESS_LETROSO_MARKER_END")?.trim() || DEFAULT_LETROSO_MARKER_END;
}

function getLetrosoHistoryMarkerStart(): string {
  return Deno.env.get("WORDPRESS_LETROSO_HISTORY_MARKER_START")?.trim() || DEFAULT_LETROSO_HISTORY_MARKER_START;
}

function getLetrosoHistoryMarkerEnd(): string {
  return Deno.env.get("WORDPRESS_LETROSO_HISTORY_MARKER_END")?.trim() || DEFAULT_LETROSO_HISTORY_MARKER_END;
}

function getLetrosoCurrentDateMarkerStart(): string {
  return Deno.env.get("WORDPRESS_LETROSO_CURRENT_DATE_MARKER_START")?.trim() || DEFAULT_LETROSO_CURRENT_DATE_MARKER_START;
}

function getLetrosoCurrentDateMarkerEnd(): string {
  return Deno.env.get("WORDPRESS_LETROSO_CURRENT_DATE_MARKER_END")?.trim() || DEFAULT_LETROSO_CURRENT_DATE_MARKER_END;
}
